...
export const genNotebookOption = (id: string, notebookId?: string) => {
    let html = `<option value="">${window.sourceflow.languages.currentNotebook}</option>`;
...
<button class="b3-button b3-button--small fn__flex-center">${window.sourceflow.languages.copy} ID</button></div>`;
...
<div class="b3-label">
    ${window.sourceflow.languages.fileTree11}
    <div class="b3-label__text">${window.sourceflow.languages.fileTree14}</div>
    <div class="fn__hr"></div>
    <input class="b3-text-field fn__flex-center fn__block" id="dailyNoteSavePath" value="">
    <div class="fn__hr"></div>
    <div class="b3-label__text">${window.sourceflow.languages.fileTree15}</div>
    <div class="fn__hr"></div>
