...
export class Bookmark extends Model {
    ...
    constructor(app: App, tab: Tab) {
        ...
        this.element.classList.add("fn__flex-column", "file-tree", "sf__bookmark", "dockPanel");
        this.element.innerHTML = `<div class="block__icons">
    <div class="block__logo">
        <svg class="block__logoicon"><use xlink:href="#iconBookmark"></use></svg>${window.sourceflow.languages.bookmark}
    </div>
