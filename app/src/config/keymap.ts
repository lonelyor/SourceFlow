...
export const keymap = {
    ...
    _genItem(keymap: Record<string, Config.IKey>, keys: string) {
        ...
        Object.keys(keymap).forEach(key => {
            if (window.sourceflow.languages[key]) {
                const keyValue = updateHotkeyTip(keymap[key].custom);
                let keymapName = window.sourceflow.languages[key];
                if ("editor" + Constants.ZWSP + "general" === keys && key === "duplicate") {
                    keymapName = `${window.sourceflow.languages.duplicate} / ${window.sourceflow.languages.duplicateMirror}`;
                }
                html += `<label class="b3-list-item b3-list-item--narrow b3-list-item--hide-action">
    <span class="b3-list-item__text">${keymapName}</span>
    <span data-type="reset" class="b3-list-item__action b3-tooltips b3-tooltips__w" aria-label="${window.sourceflow.languages.reset}">
        <svg><use xlink:href="#iconUndo"></use></svg>
    </span>
    <span data-type="clear" class="b3-list-item__action b3-tooltips b3-tooltips__w" aria-label="${window.sourceflow.languages.remove}">
...
<div class="fn__none b3-list__panel">
    ...
    <div class="b3-list-item b3-list-item--narrow toggle">
        ...
        <span class="b3-list-item__text ft__on-surface">${window.sourceflow.languages.plugin}</span>
    </div>
    ...
    <span class="fn__flex-center">${window.sourceflow.languages.keymapTip}</span>
    <span class="fn__flex-1"></span>
    <button id="keymapRefreshBtn" class="b3-button b3-button--outline fn__flex-center fn__size200">
        <svg><use xlink:href="#iconRefresh"></use></svg>
        ${window.sourceflow.languages.refresh}
    </button>
</div>
<div class="fn__flex b3-label config__item">
    <span class="fn__flex-center">${window.sourceflow.languages.keymapTip2}</span>
    <span class="fn__flex-1"></span>
    <span class="fn__space"></span>
    <button id="keymapResetBtn" class="b3-button b3-button--outline fn__flex-center fn__size200">
        <svg><use xlink:href="#iconUndo"></use></svg>
        ${window.sourceflow.languages.reset}
    </button>
</div>
<div class="b3-label file-tree config-keymap" id="keymapList">
    <div class="fn__flex config__item">
        <label class="b3-form__icon fn__block">
            ...
            <input id="keymapInput" class="b3-form__icon-input b3-text-field fn__block" placeholder="${window.sourceflow.languages.search}">
        </label>
        <div class="fn__space"></div>
        <label class="b3-form__icon fn__block searchByKeyLabel">
            <svg class="b3-form__icon-icon"><use xlink:href="#iconKeymap"></use></svg>
            <input id="searchByKey" style="font-family: var(--b3-font-family-kbd);" data-keymap="" class="b3-form__icon-input b3-text-field fn__block" spellcheck="false" placeholder="${window.sourceflow.languages.keymap}">
        </label>
        <div class="fn__space"></div>
        <button id="clearSearchBtn" class="b3-button b3-button--outline fn__flex-center fn__size200">
            ...
            ${window.sourceflow.languages.clear}
        </button>
    </div>
    ...
    <div class="b3-list b3-list--border b3-list--background">
        <div class="b3-list-item b3-list-item--narrow toggle">
            ...
            <span class="b3-list-item__text ft__on-surface">${window.sourceflow.languages.general}</span>
        </div>
        <div class="fn__none b3-list__panel">${keymap._genItem(window.sourceflow.config.keymap.general, "general")}</div>
    </div>
    <div class="b3-list b3-list--border b3-list--background">
        <div class="b3-list-item b3-list-item--narrow toggle">
            <span class="b3-list-item__toggle b3-list-item__toggle--hl">
            ...
            <span class="b3-list-item__text ft__on-surface">${window.sourceflow.languages.editor}</span>
        </div>
        <div class="b3-list__panel">
            <div class="b3-list-item b3-list-item--narrow toggle">
                <span class="b3-list-item__toggle b3-list-item__toggle--hl">
            ...
            <div class="fn__none b3-list__panel">${keymap._genItem(window.sourceflow.config.keymap.editor.general, "editor" + Constants.ZWSP + "general")}</div>
            <div class="b3-list-item b3-list-item--narrow toggle">
                <span class="b3-list-item__toggle b3-list-item__toggle--hl">
                    <svg class="b3-list-item__arrow"><use xlink:href="#iconRight"></use></svg>
                </span>
                <span class="b3-list-item__text ft__on-surface">${window.sourceflow.languages.element}</span>
            </div>
            <div class="fn__none b3-list__panel">${keymap._genItem(window.sourceflow.config.keymap.editor.insert, "editor" + Constants.ZWSP + "insert")}</div>
            <div class="b3-list-item b3-list-item--narrow toggle">
                <span class="b3-list-item__toggle b3-list-item__toggle--hl">
                    <svg class="b3-list-item__arrow"><use xlink:href="#iconRight"></use></svg>
                </span>
                <span class="b3-list-item__text ft__on-surface">${window.sourceflow.languages.headings}</span>
            </div>
            <div class="fn__none b3-list__panel">${keymap._genItem(window.sourceflow.config.keymap.editor.heading, "editor" + Constants.ZWSP + "heading")}</div>
            <div class="b3-list-item b3-list-item--narrow toggle">
                <span class="b3-list-item__toggle b3-list-item__toggle--hl">
                    <svg class="b3-list-item__arrow"><use xlink:href="#iconRight"></use></svg>
                </span>
                <span class="b3-list-item__text ft__on-surface">${window.sourceflow.languages.list1}</span>
            </div>
            <div class="fn__none b3-list__panel">${keymap._genItem(window.sourceflow.config.keymap.editor.list, "editor" + Constants.ZWSP + "list")}</div>
            <div class="b3-list-item b3-list-item--narrow toggle">
                <span class="b3-list-item__toggle b3-list-item__toggle--hl">
                    <svg class="b3-list-item__arrow"><use xlink:href="#iconRight"></use></svg>
                </span>
                <span class="b3-list-item__text ft__on-surface">${window.sourceflow.languages.table}</span>
            </div>
            <div class="fn__none b3-list__panel">${keymap._genItem(window.sourceflow.config.keymap.editor.table, "editor" + Constants.ZWSP + "table")}</div>
        </div>
    </div>
    ${pluginHtml}
</div>`;
    ...
    _setkeymap(app: App) {
        const data: Config.IKeymap = JSON.parse(JSON.stringify(Constants.SOURCEFLOW_KEYMAP));
        const oldToggleWin = window.sourceflow.config.keymap.general.toggleWin.custom;
        keymap.element.querySelectorAll("label.b3-list-item input").forEach((item) => {
            ...
            if (keys[0] === "plugin") {
                window.sourceflow.config.keymap.plugin[keys[1]][keys[2]].custom = newHotkey;
                data.plugin = window.sourceflow.config.keymap.plugin;
        ...
        window.sourceflow.config.keymap = data;
        fetchPost("/api/setting/setKeymap", {
            ...
            ipcRenderer.send(Constants.SOURCEFLOW_CMD, {
                cmd: "writeLog",
                msg: "user update keymap:" + JSON.stringify(window.sourceflow.config.keymap)
            });
            if (oldToggleWin !== window.sourceflow.config.keymap.general.toggleWin.custom) {
                ipcRenderer.send(Constants.SOURCEFLOW_CMD, {
                    cmd: "unregisterGlobalShortcut",
    ...
    bindEvent(app: App) {
        ...
        keymap.element.querySelector("#keymapResetBtn").addEventListener("click", () => {
            confirmDialog("⚠️ " + window.sourceflow.languages.reset, window.sourceflow.languages.confirmReset, () => {
                fetchPost("/api/setting/setKeymap", {
                    data: Constants.SOURCEFLOW_KEYMAP,
                }, () => {
                    /// #if !BROWSER
                    ipcRenderer.send(Constants.SOURCEFLOW_CMD, {
                        cmd: "writeLog",
                    ...
                    if (window.sourceflow.config.keymap.general.toggleWin.default !== window.sourceflow.config.keymap.general.toggleWin.custom) {
                        ipcRenderer.send(Constants.SOURCEFLOW_CMD, {
                            cmd: "unregisterGlobalShortcut",
            ...
            item.addEventListener("keydown", function (event: KeyboardEvent) {
                ...
                timeout = window.setTimeout(() => {
                    ...
                    if (isAssistKey ||
                        ...
                        if (!isAssistKey) {
                            showMessage(`${window.sourceflow.languages.invalid} [${adoptKeymapStr}]`);
                        }
                        hasConflict = true;
                    }
                    Array.from(keymap.element.querySelectorAll("label.b3-list-item input")).find((inputItem: HTMLElement) => {
                        if ((inputItem !== this) && inputItem.getAttribute("data-value") === keymapStr) {
                            ...
                            showMessage(`${window.sourceflow.languages.conflict} [${keymap._getTip(inputItem)} ${adoptKeymapStr}]`);
                            hasConflict = true;
                            return true;
                        }
                    });
