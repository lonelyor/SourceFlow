...
export class Asset extends Model {
    ...
    private render(isInit = true) {
        ...
        if (Constants.SOURCEFLOW_ASSETS_IMAGE.includes(type)) {
        ...
        } else if (Constants.SOURCEFLOW_ASSETS_AUDIO.includes(type)) {
        ...
        } else if (Constants.SOURCEFLOW_ASSETS_VIDEO.includes(type)) {
      ...
      <div id="sidebarContainer">
        <div id="toolbarSidebar">
          <div id="toolbarSidebarLeft">
              <button id="viewThumbnail" class="toolbarButton toggled b3-tooltips b3-tooltips__ne" aria-label="${window.sourceflow.languages.thumbsTitle}">
                <svg><use xlink:href="#iconImage"></use></svg>
              </button>
              <button id="viewOutline" class="toolbarButton b3-tooltips b3-tooltips__ne" aria-label="${window.sourceflow.languages.outline}">
          ...
          <div id="toolbarSidebarRight">
            <div id="outlineOptionsContainer" class="fn__hidden">
              <button id="currentOutlineItem" class="toolbarButton b3-tooltips b3-tooltips__nw" disabled="disabled" aria-label="${window.sourceflow.languages.focusOutline}">
      ...
      <div id="mainContainer">
        <div class="findbar b3-menu fn__hidden doorHanger" id="findbar">
            <input id="findInput" class="toolbarField b3-text-field" placeholder="${window.sourceflow.languages.search}">
            <div class="fn__space"></div>
            <button id="findPreviousButton" class="toolbarButton findPrevious b3-tooltips b3-tooltips__n" aria-label="${window.sourceflow.languages.previous}">
                <svg><use xlink:href="#iconUp"></use></svg>
            </button>
            <button id="findNextButton" class="toolbarButton findNext b3-tooltips b3-tooltips__n" aria-label="${window.sourceflow.languages.next}">
                <svg><use xlink:href="#iconDown"></use></svg>
            </button>
            <label class="b3-button b3-button--outline b3-button--small">
                <input type="checkbox" id="findHighlightAll" class="toolbarField">
                ${window.sourceflow.languages.findHighlight}
            </label>
            <div class="fn__space"></div>
            <label class="b3-button b3-button--outline b3-button--small">
                <input type="checkbox" id="findMatchCase" class="toolbarField">
                ${window.sourceflow.languages.searchCaseSensitive}
            </label>
            <div class="fn__space"></div>
            <label class="b3-button b3-button--outline b3-button--small">
                <input type="checkbox" id="findMatchDiacritics" class="toolbarField">
                ${window.sourceflow.languages.matchDiacritics}
            </label>
            <div class="fn__space"></div>
            <label class="b3-button b3-button--outline b3-button--small">
                <input type="checkbox" id="findEntireWord" class="toolbarField">
                ${window.sourceflow.languages.findEntireWord}
            </label>
            <div class="fn__space"></div>
        ...
        <div id="secondaryToolbar" class="secondaryToolbar fn__hidden doorHangerRight b3-menu">
          <div id="secondaryToolbarButtonContainer" class="b3-menu__items">
            <button id="pdfLight" class="secondaryToolbarButton b3-menu__item toggled">
              ...
              <span class="b3-menu__label">${window.sourceflow.languages.themeLight}</span>
            </button>
            <button id="pdfDark" class="secondaryToolbarButton b3-menu__item">
              <svg class="b3-menu__icon"><use xlink:href="#iconDark"></use></svg> 
              <span class="b3-menu__label">${window.sourceflow.languages.themeDark}</span>
            </button>
            ...
            <button id="previous" class="secondaryToolbarButton b3-menu__item pageUp">
              ...
              <span class="b3-menu__label">${window.sourceflow.languages.previousLabel}</span>
            ...
            <button id="next" class="secondaryToolbarButton b3-menu__item pageDown">
              ...
              <span class="b3-menu__label">${window.sourceflow.languages.nextLabel}</span>
            ...
            <button id="firstPage" class="secondaryToolbarButton b3-menu__item firstPage">
              ...
              <span class="b3-menu__label">${window.sourceflow.languages.firstPage}</span>
            ...
            <button id="lastPage" class="secondaryToolbarButton b3-menu__item lastPage">
              ...
              <span class="b3-menu__label">${window.sourceflow.languages.lastPage}</span>
            ...
            <button id="zoomOutButton" class="secondaryToolbarButton b3-menu__item zoomOut">
               ...
               <span class="b3-menu__label">${window.sourceflow.languages.zoomOut}</span>
            ...
            <button id="zoomInButton" class="secondaryToolbarButton b3-menu__item zoomIn">
               ...
               <span class="b3-menu__label">${window.sourceflow.languages.zoomIn}</span>
               <span class="b3-menu__accelerator b3-menu__accelerator--hotkey">${updateHotkeyTip("⌘=")}</span>
            </button>
            <button id="pageRotateCw" class="secondaryToolbarButton b3-menu__item rotateCw">
               ...
               <span class="b3-menu__label">${window.sourceflow.languages.rotateCw}</span>
            ...
            <button id="pageRotateCcw" class="secondaryToolbarButton b3-menu__item rotateCcw">
               ...
               <span class="b3-menu__label">${window.sourceflow.languages.rotateCcw}</span>
            ...
            <button id="cursorSelectTool" class="secondaryToolbarButton b3-menu__item selectTool toggled">
               ...
               <span class="b3-menu__label">${window.sourceflow.languages.cursorText}</span>
            ...
            <button id="cursorHandTool" class="secondaryToolbarButton b3-menu__item handTool">
              ...
              <span class="b3-menu__label">${window.sourceflow.languages.cursorHand}</span>
            ...
            <button id="scrollVertical" class="secondaryToolbarButton b3-menu__item scrollModeButtons scrollVertical toggled">
             <svg class="b3-menu__icon"><use xlink:href="#iconScrollVert"></use></svg> 
              <span class="b3-menu__label">${window.sourceflow.languages.scrollVertical}</span>
            </button>
            <button id="scrollHorizontal" class="secondaryToolbarButton b3-menu__item scrollModeButtons scrollHorizontal">
              ...
              <span class="b3-menu__label">${window.sourceflow.languages.scrollHorizontal}</span>
            </button>
            <button id="scrollWrapped" class="secondaryToolbarButton b3-menu__item scrollModeButtons scrollWrapped">
             <svg class="b3-menu__icon"><use xlink:href="#iconScrollWrapped"></use></svg> 
              <span class="b3-menu__label">${window.sourceflow.languages.scrollWrapped}</span>
            </button>
            ...
            <button id="spreadNone" class="secondaryToolbarButton b3-menu__item spreadModeButtons spreadNone toggled">
              ...
              <span class="b3-menu__label">${window.sourceflow.languages.spreadNone}</span>
            </button>
            <button id="spreadOdd" class="secondaryToolbarButton b3-menu__item spreadModeButtons spreadOdd">
              ...
              <span class="b3-menu__label">${window.sourceflow.languages.spreadOdd}</span>
            </button>
            <button id="spreadEven" class="secondaryToolbarButton b3-menu__item spreadModeButtons spreadEven">
              ...
              <span class="b3-menu__label">${window.sourceflow.languages.spreadEven}</span>
            </button>
            <button id="presentationMode" class="secondaryToolbarButton b3-menu__item presentationMode">
              ...
              <span class="b3-menu__label">${window.sourceflow.languages.presentationMode}</span>
            ...
            <button id="documentProperties" class="secondaryToolbarButton b3-menu__item documentProperties">
              ...
              <span class="b3-menu__label">${window.sourceflow.languages.attr}</span>
            </button>
          </div>
        ...
        <div class="pdf__toolbar">
          <div id="toolbarContainer">
            <div id="toolbarViewer">
                <button id="sidebarToggleButton" class="toolbarButton b3-tooltips b3-tooltips__se" aria-expanded="false" aria-controls="sidebarContainer" aria-label="${window.sourceflow.languages.toggleSidebarNotification2Title} ${updateHotkeyTip("F4")}">
                    <svg><use xlink:href="#iconLayoutRight"></use></svg>
                </button>
                <button id="viewFindButton" class="toolbarButton b3-tooltips b3-tooltips__se" aria-expanded="false" aria-controls="findbar" aria-label="${window.sourceflow.languages.search} ${updateHotkeyTip("⌘F")}">
                  <svg><use xlink:href="#iconSearch"></use></svg>
                </button>
                <button id="rectAnno" class="toolbarButton b3-tooltips b3-tooltips__se" aria-expanded="false" aria-controls="findbar" aria-label="${window.sourceflow.languages.rectAnnotation} ${updateHotkeyTip("⌘D")}/${updateHotkeyTip("⌥D")}">
                ...
                <span id="scaleSelectContainer" class="dropdownToolbarButton">
                  <select id="scaleSelect" class="b3-select">
                    <option id="pageAutoOption" value="auto" selected="selected">${window.sourceflow.languages.pageScaleAuto}</option>
                    <option id="pageActualOption" value="page-actual">${window.sourceflow.languages.pageScaleActual}</option>
                    <option id="pageFitOption" value="page-fit">${window.sourceflow.languages.pageScaleFit}</option>
                    <option id="pageWidthOption" value="page-width">${window.sourceflow.languages.pageScaleWidth}</option>
                ...
                <button id="secondaryToolbarToggleButton" class="toolbarButton b3-tooltips b3-tooltips__sw" aria-label="${window.sourceflow.languages.more}" aria-expanded="false" aria-controls="secondaryToolbar">
      ...
      <div id="dialogContainer">
        ...
        <div class="dialog" id="documentPropertiesDialog">
            <div class="row">
              <span>${window.sourceflow.languages.fileName}</span> <p id="fileNameField">-</p>
            </div>
            <div class="row">
              <span>${window.sourceflow.languages.fileSize}</span> <p id="fileSizeField">-</p>
            </div>
            <div class="separator"></div>
            <div class="row">
              <span>${window.sourceflow.languages.title1}</span> <p id="titleField">-</p>
            </div>
            <div class="row">
              <span>${window.sourceflow.languages.author}</span> <p id="authorField">-</p>
            </div>
            <div class="row">
              <span>${window.sourceflow.languages.subject}</span> <p id="subjectField">-</p>
            </div>
            <div class="row">
              <span>${window.sourceflow.languages.keywords}</span> <p id="keywordsField">-</p>
            </div>
            <div class="row">
              <span>${window.sourceflow.languages.creationDate}</span> <p id="creationDateField">-</p>
            </div>
            <div class="row">
              <span>${window.sourceflow.languages.modificationDate}</span> <p id="modificationDateField">-</p>
            </div>
            <div class="row">
              <span>${window.sourceflow.languages.creator}</span> <p id="creatorField">-</p>
            </div>
            <div class="separator"></div>
            <div class="row">
              <span>PDF ${window.sourceflow.languages.producer}</span> <p id="producerField">-</p>
            </div>
            <div class="row">
              <span>PDF ${window.sourceflow.languages.version}</span> <p id="versionField">-</p>
            </div>
            <div class="row">
              <span>${window.sourceflow.languages.pageCount}</span> <p id="pageCountField">-</p>
            </div>
            <div class="row">
              <span>${window.sourceflow.languages.pageSize}</span> <p id="pageSizeField">-</p>
            </div>
            <div class="separator"></div>
            <div class="row">
              <span>${window.sourceflow.languages.linearized}</span> <p id="linearizedField">-</p>
            </div>
            <div class="buttonRow">
              <button id="documentPropertiesClose" class="b3-button"><span>${window.sourceflow.languages.close}</span></button>
            </div>
        </div>
    ...
    <div id="printContainer"></div>`;
            const localPDF = window.sourceflow.storage[Constants.LOCAL_PDFTHEME];
            const pdfTheme = window.sourceflow.config.appearance.mode === 0 ? localPDF.light : localPDF.dark;
            ...
            lightElement.addEventListener("click", () => {
                if (window.sourceflow.config.appearance.mode === 0) {
                ...
                lightElement.classList.add("toggled");
                darkElement.classList.remove("toggled");
                setStorageVal(Constants.LOCAL_PDFTHEME, window.sourceflow.storage[Constants.LOCAL_PDFTHEME]);
            });
