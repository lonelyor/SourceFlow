...
class PDFThumbnailView {
  ...
  constructor({
    ...
    // NOTE
    anchor.title = window.sourceflow.languages.thumbPageTitle.replace('{{page}}', JSON.parse(this.#pageL10nArgs).page)
  ...
  setPageLabel(label) {
    ...
    // NOTE
    this.anchor.title = window.sourceflow.languages.thumbPageTitle.replace('{{page}}', JSON.parse(this.#pageL10nArgs).page)
