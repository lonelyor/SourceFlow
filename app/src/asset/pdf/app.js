...
class PDFViewerApplication {
    ...
    async open(args) {
        ...
        return loadingTask.promise.then(
            ...
            reason => {
                ...
                return this._documentError(window.sourceflow.languages[key], {message: reason.message}).then(
                    () => {
                        throw reason;
                    }
                );
    ...
    async _otherError(key, moreInfo = null) {
        // NOTE
        const message = window.sourceflow.languages[key] || key;
                ...
                .then(async ([timeStamp, stored, pageLayout, pageMode, openAction]) => {
                    ...
                    if (stored?.page && viewOnLoad !== ViewOnLoad.INITIAL) {
                        hash =
                            ...
                            // NOTE https://github.com/lonelyor/SourceFlow/issues/12291
    ...
    beforePrint() {
        ...
        if (!this.supportsPrinting) {
            // NOTE
            this._otherError(window.sourceflow.languages.printingNotSupported);
            return;
        }
...
if (typeof PDFJSDev === "undefined" || PDFJSDev.test("GENERIC")) {
    ...
    var validateFileURL = function (file) {
        ...
        try {
            ...
            // NOTE
            console.log(window.sourceflow.languages.loadingError, ex.message)
...
function onClick(evt) {
    // 点击后证快捷键可正常使用，select 等也可正常使用 https://github.com/lonelyor/SourceFlow/issues/7869
...
function onKeyDown(evt) {
    ...
    if (cmd === 0 && [38, 40].includes(evt.keyCode)) {
        // NOTE https://github.com/lonelyor/SourceFlow/issues/8164
