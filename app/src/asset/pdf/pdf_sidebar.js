...
class PDFSidebar {
  ...
  #showUINotification() {
    // NOTE
    this.toggleButton.title = window.sourceflow.languages.toggleSidebarNotification2Title
  ...
  #hideUINotification(reset = false) {
    ...
    if (reset) {
      // NOTE
      this.toggleButton.title = window.sourceflow.languages.toggleSidebarTitle
      // this.toggleButton.setAttribute(
      //   "data-l10n-id",
