...
declare const SOURCEFLOW_VERSION: string;
declare const NODE_ENV: string;

const _SOURCEFLOW_VERSION = SOURCEFLOW_VERSION;
...
export abstract class Constants {
    public static readonly SOURCEFLOW_VERSION: string = _SOURCEFLOW_VERSION;
    public static readonly NODE_ENV: string = _NODE_ENV;
    public static readonly SOURCEFLOW_APPID: string = Math.random().toString(36).substring(8);

    // 服务器地址
    public static readonly ASSETS_ADDRESS: string = "https://raw.githubusercontent.com/lonelyor/SourceFlow/main/assets/";
    ...
    // drop 事件
    public static readonly SOURCEFLOW_DROP_FILE: string = "application/sourceflow-file";
    public static readonly SOURCEFLOW_DROP_GUTTER: string = "application/sourceflow-gutter";
    public static readonly SOURCEFLOW_DROP_TAB: string = "application/sourceflow-tab";
    public static readonly SOURCEFLOW_DROP_EDITOR: string = "application/sourceflow-editor";

    // 渲染进程调主进程
    public static readonly SOURCEFLOW_CMD: string = "sourceflow-cmd";
    public static readonly SOURCEFLOW_GET: string = "sourceflow-get";
    public static readonly SOURCEFLOW_EVENT: string = "sourceflow-event";

    public static readonly SOURCEFLOW_CONFIG_TRAY: string = "sourceflow-config-tray";
    public static readonly SOURCEFLOW_QUIT: string = "sourceflow-quit";
    public static readonly SOURCEFLOW_HOTKEY: string = "sourceflow-hotkey";
    public static readonly SOURCEFLOW_INIT: string = "sourceflow-init";
    public static readonly SOURCEFLOW_READY_TO_SHOW: string = "sourceflow-ready-to-show";
    public static readonly SOURCEFLOW_SEND_WINDOWS: string = "sourceflow-send-windows"; // 主窗口和各新窗口之间的通信，{cmd: "closetab"|"lockscreen"|"lockscreenByMode", data: {}})
    public static readonly SOURCEFLOW_SAVE_CLOSE: string = "sourceflow-save-close";
    public static readonly SOURCEFLOW_AUTO_LAUNCH: string = "sourceflow-auto-launch";

    public static readonly SOURCEFLOW_OPEN_WORKSPACE: string = "sourceflow-open-workspace";
    public static readonly SOURCEFLOW_OPEN_URL: string = "sourceflow-open-url";
    public static readonly SOURCEFLOW_OPEN_WINDOW: string = "sourceflow-open-window";
    public static readonly SOURCEFLOW_OPEN_FILE: string = "sourceflow-open-file";
    ...
    public static readonly SOURCEFLOW_CONTEXT_MENU: string = "sourceflow-context-menu";
    public static readonly SOURCEFLOW_CONFIRM_DIALOG: string = "sourceflow-confirm-dialog";
    public static readonly SOURCEFLOW_ALERT_DIALOG: string = "sourceflow-alert-dialog";

    public static readonly SOURCEFLOW_SHOW_WINDOW: string = "sourceflow-show-window";
    ...
    public static readonly CUSTOM_SF_READONLY: string = "custom-sf-readonly";
    public static readonly CUSTOM_SF_FULLWIDTH: string = "custom-sf-fullwidth";
    ...
    public static readonly CB_GET_OPENNEW = "cb-get-opennew"; // 编辑器只读后新建文件需为临时解锁状态 & https://github.com/lonelyor/SourceFlow/issues/12197
    ...
    public static readonly LOCAL_PLUGIN_GUARD = "local-plugin-guard";
    ...
    public static readonly LOCAL_SYNC_RESTORE = "local-sync-restore";
    public static readonly LOCAL_CAPTURE = "local-capture";
    public static readonly LOCAL_WORKBENCH = "local-workbench";
    ...
    // "⌥↩" 写死，但可自定义
    public static readonly SOURCEFLOW_KEYMAP: Config.IKeymap = {
        general: {
            ...
            backlinks: {default: altNumber + "6", custom: altNumber + "6"},
            graphView: {default: altNumber + "7", custom: altNumber + "7"},
            globalGraph: {default: altNumber + "8", custom: altNumber + "8"},
    ...
    public static readonly SOURCEFLOW_EMPTY_LAYOUT: Config.IUiLayout = {
        hideDock: false,
        layout: {
            "direction": "tb",
            "size": "0px",
    ...
    public static readonly SOURCEFLOW_DEFAULT_REPLACETYPES: Required<Config.IUILayoutTabSearchConfigReplaceTypes> = {
        "text": true,
        "imgText": true,
        "imgTitle": true,
        "imgSrc": true,
    ...
    public static readonly SOURCEFLOW_IMAGE_VIP: string = `<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
...
<path fill="#ffd00f" d="M13.868 6.478c0 0.946 0.767 1.712 1.712 1.712s1.712-0.767 1.712-1.712v0c0-0.945-0.766-1.712-1.712-1.712s-1.712 0.766-1.712 1.712v0zM28.577 10.818c0 0.945 0.766 1.712 1.712 1.712s1.712-0.766 1.712-1.712v0c0-0.945-0.766-1.712-1.712-1.712s-1.712 0.766-1.712 1.712v0zM0 10.822c0 0.945 0.766 1.712 1.712 1.712s1.712-0.766 1.712-1.712v0c0-0.945-0.766-1.712-1.712-1.712s-1.712 0.766-1.712 1.712v0z"></path>
    ...
    public static readonly SOURCEFLOW_ASSETS_IMAGE: string[] = [".apng", ".ico", ".cur", ".jpg", ".jpe", ".jpeg", ".jfif", ".pjp", ".pjpeg", ".png", ".gif", ".webp", ".bmp", ".svg", ".avif", ".tiff", ".tif"];
    public static readonly SOURCEFLOW_ASSETS_AUDIO: string[] = [".mp3", ".wav", ".ogg", ".m4a", ".aac", ".flac"];
    public static readonly SOURCEFLOW_ASSETS_VIDEO: string[] = [".mov", ".weba", ".mkv", ".mp4", ".webm"];
    public static readonly SOURCEFLOW_ASSETS_EXTS: string[] = [".pdf"].concat(Constants.SOURCEFLOW_ASSETS_IMAGE, Constants.SOURCEFLOW_ASSETS_AUDIO, Constants.SOURCEFLOW_ASSETS_VIDEO);
    public static readonly SOURCEFLOW_ASSETS_SEARCH: string[] = [".txt", ".md", ".markdown", ".docx", ".xlsx", ".pptx", ".pdf", ".json", ".log", ".sql", ".html", ".xml", ".java", ".h", ".c",
        ".cpp", ".go", ".rs", ".swift", ".kt", ".py", ".php", ".js", ".css", ".ts", ".sh", ".bat", ".cmd", ".ini", ".yaml",
        ".rst", ".adoc", ".textile", ".opml", ".org", ".wiki", ".epub", ".cs"];

    // protyle
    public static readonly SOURCEFLOW_CONFIG_APPEARANCE_DARK_CODE: string[] = ["a11y-dark", "agate", "an-old-hope", "androidstudio",
    ...
    public static readonly SOURCEFLOW_CONFIG_APPEARANCE_LIGHT_CODE: string[] = ["ant-design",
    ...
    public static readonly SOURCEFLOW_RENDER_CODE_LANGUAGES: string[] = [
