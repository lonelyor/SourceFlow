...
type TProtyleAction = "cb-get-append" | // 向下滚动加载
    ...
    "cb-get-history" | // 历史渲染
    "cb-get-opennew" | // 编辑器只读后新建文件需为临时解锁状态 & https://github.com/lonelyor/SourceFlow/issues/12197
...
interface IHint {
    ...
    delay?: number;
    /** 默认表情，可从 [lute/emoji_map](/third_party/go/lute/parse/emoji_map.go) 中选取，也可自定义 */
    emoji?: IObject;
    emojiPath?: string;
    extend?: IHintExtend[];
}
