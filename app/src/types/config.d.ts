...
declare namespace Config {
    ...
    /**
     * SourceFlow appearance related configuration
     */
    export interface IAppearance {
        ...
        /**
         * Dark code block skin
         */
        codeBlockSkinDark: string;
        /**
         * Light code block theme
         */
        codeBlockThemeLight: string;
        /**
         * Light code block skin
         */
        codeBlockSkinLight: string;
        /**
        ...
        themeVer: string;
        /**
         * Startup page background image
         */
        startupPageImage: string;
        /**
         * Startup page background opacity (0-100)
         */
        startupPageOpacity: number;
        /**
         * Startup page background blur in pixels
         */
        startupPageBlur: number;
        /**
         * Whether to enable the floating mascot
         */
        mascotEnabled: boolean;
        /**
         * Floating mascot image source
         */
        mascotImage: string;
        /**
        ...
        /**
         * Floating mascot effect preset
         */
        mascotEffect: "float" | "sway" | "pulse" | "none";
        /**
         * Floating mascot opacity percentage
         */
    ...
    /**
     * SourceFlow bazaar related configuration
     */
    export interface IBazaar {
        /**
         * Optional bazaar hash override
         */
        bazaarHash: string;
        /**
         * Optional bazaar package download base URL
         */
        bazaarPackageBaseURL: string;
        /**
         * Optional bazaar README CDN base URL
         */
        bazaarReadmeCDNBaseURL: string;
        /**
         * Optional bazaar stage index base URL
         */
        bazaarStageBaseURL: string;
        /**
         * Optional bazaar statistics base URL
         */
        bazaarStatBaseURL: string;
        /**
         * Optional bazaar version info URL
         */
        bazaarVersionInfoURL: string;
        /**
    ...
    /**
     * SourceFlow editor markdown related configuration
     */
    interface IMarkdown {
        /**
    ...
    /**
     * SourceFlow editor related configuration
     */
    export interface IEditor {
        ...
        cursorPreset: string;
        /**
         * Editor caret color preset
         */
        cursorColor: string;
        /**
         * Custom editor caret image source (data URL or remote URL)
         */
        cursorImage: string;
        /**
         * Custom editor caret image name
         */
        cursorImageName: string;
        /**
         * Whether to tint custom SVG editor caret images with the selected color
         */
        cursorImageTint: boolean;
        /**
         * Custom editor caret image width as a percentage of the editor font size
         */
        cursorImageWidthPercent: number;
        /**
         * Custom editor caret image height as a percentage of the editor font size
         */
        cursorImageHeightPercent: number;
        /**
         * Custom editor caret image horizontal offset in pixels
         */
        cursorImageOffsetX: number;
        /**
         * Custom editor caret image vertical offset in pixels
         */
        cursorImageOffsetY: number;
        /**
         * Saved local custom cursor images
         */
        cursorSavedImages: IEditorCursorSavedImage[];
        /**
         * Whether the editor caret blinks
         */
        cursorBlink: boolean;
        /**
         * The editor caret blink effect
         */
        cursorBlinkEffect: string;
        /**
         * Hidden block overlay color. Empty means follow the theme color.
         */
        hiddenBlockColor: string;
        /**
         * Note editor background image source
         */
        noteBackgroundImage: string;
        /**
         * Note editor background opacity percentage
         */
        noteBackgroundOpacity: number;
        /**
         * Note editor background blur in pixels
         */
        noteBackgroundBlur: number;
        /**
         * Image upload provider
         */
        assetUploadProvider: "local" | "picgo";
        /**
         * PicGo Server URL
         */
        ...
        /**
         * Default HTML paste mode
         */
        htmlPasteMode: TEditorHTMLPasteMode;
        /**
    ...
    /**
     * SourceFlow export related configuration
     */
    ...
    export interface IFileTree {
        ...
        sort: number;
        /**
         * Whether to save the content of the .sf file as a single-line JSON object
         */
        useSingleLineSave: boolean;
        /**
         * The .sf and database .json files larger than this value will prompt a warning (unit: MB)
         */
    ...
    /**
     * SourceFlow graph related configuration
     */
    ...
    /**
     * SourceFlow keymap related configuration
     */
    ...
    /**
     * SourceFlow editor shortcut keys
     */
    ...
    /**
     * SourceFlow editor general shortcut keys
     */
    ...
    /**
     * SourceFlow editor heading shortcut keys
     */
    ...
    /**
     * SourceFlow editor insert shortcut keys
     */
    ...
    /**
     * SourceFlow editor list shortcut keys
     */
    ...
    /**
     * SourceFlow editor table shortcut keys
     */
    ...
    /**
     * SourceFlow general shortcut keys
     */
    ...
    /**
     * SourceFlow plugin shortcut keys
     */
    ...
    export interface IRepo {
        ...
        /**
         * Automatic retention for remote restore points in recent hours
         */
        remoteRetentionRecentHours: number;
        /**
         * Automatic retention for remote restore points in recent days
         */
        remoteRetentionRecentDays: number;
    }

    /**
     * SourceFlow search related configuration
     */
    ...
    /**
     * SourceFlow code snippets related configuration
     */
    ...
    /**
     * SourceFlow workspace content statistics
     */
    ...
    /**
     * SourceFlow synchronization related configuration
     */
    ...
    export interface ISystem {
        /**
         * The absolute path of the `resources` directory under the SourceFlow installation directory
         */
        appDir: string;
        /**
         * Boot automatically
        ...
        /**
         * Whether the current session is running in portable mode
         */
        isPortable: boolean;
        /**
         * Whether the current machine has registered the `sf://` protocol for the app
         */
        protocolClientRegistered: boolean;
        /**
    ...
    /**
     * SourceFlow Network proxy configuration
     */
    ...
    /**
     * SourceFlow tag dock related configuration
     */
    ...
    /**
     * SourceFlow UI layout related configuration
     */
    ...
    /**
     * SourceFlow dock related configuration
     */
    ...
    /**
     * SourceFlow search tab configuration
     */
    export interface IUILayoutTabSearchConfig {
         ...
         * 移除后需记录搜索内容 https://github.com/lonelyor/SourceFlow/issues/7745
         */
        removed?: boolean;
