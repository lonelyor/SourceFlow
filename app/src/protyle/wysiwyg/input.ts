...
export const input = async (protyle: IProtyle, blockElement: HTMLElement, range: Range, needRender = true, event?: InputEvent) => {
    ...
    if (!editElement) {
        // hr、嵌入块、数学公式、iframe、音频、视频、图表渲染块等不允许输入 https://github.com/lonelyor/SourceFlow/issues/3958
        if (type === "NodeThematicBreak") {
            ...
            // https://github.com/lonelyor/SourceFlow/issues/15761
    ...
    if (event) {
        ...
        // https://github.com/lonelyor/SourceFlow/issues/12468
        if ((event.inputType === "deleteContentBackward" || event.inputType === "deleteContentForward") &&
            wbrNextElement && wbrNextElement.nodeType === 1 && wbrNextElement.tagName === "BR") {
            // https://github.com/lonelyor/SourceFlow/issues/13190
            ...
            // https://github.com/lonelyor/SourceFlow/issues/14290
    ...
    if ((type !== "NodeCodeBlock" && type !== "NodeHeading") && // https://github.com/lonelyor/SourceFlow/issues/11851
    ...
    // https://github.com/lonelyor/SourceFlow/issues/9015
    ...
    if (["---", "___", "***"].includes(editElement.textContent) && type !== "NodeCodeBlock") {
        ...
        // https://github.com/lonelyor/SourceFlow/issues/12593
        ...
        if (type !== "NodeCodeBlock" && (
            ...
            if (trimStartHTML.indexOf("\n") === -1 && trimStartHTML.replace(/·|~/g, "`").replace(/^`{3,}/g, "").indexOf("`") > -1) {
                ...
                if (replaceInnerHTML.endsWith("\n```<wbr>") &&
                    ...
                    // 匹配已闭合的不需添加 https://github.com/lonelyor/SourceFlow/issues/16053
                } else if (!replaceInnerHTML.endsWith("\n```")) {
                    // 以 "\n```<wbr>" 结尾需要添加的情况 https://github.com/lonelyor/SourceFlow/issues/16519
    ...
    if (needRender && (
            ...
            // 内容删空后使用上下键，光标无法到达 https://github.com/lonelyor/SourceFlow/issues/4167
        ...
        // https://github.com/lonelyor/SourceFlow/issues/8972
        ...
        Array.from(tempElement.content.children).forEach((item, index) => {
            ...
            if (realType === "NodeCodeBlock") {
                ...
                // https://github.com/lonelyor/SourceFlow/issues/6087
                ...
                if (index === tempElement.content.childElementCount - 1) {
                    // https://github.com/lonelyor/SourceFlow/issues/11156
                    ...
                    // 表格出现滚动条，输入数字会向前滚 https://github.com/lonelyor/SourceFlow/issues/3650
                    if (scrollLeft > 0) {
                        blockElement.firstElementChild.scrollLeft = scrollLeft;
                    }
                }
            }
            // https://github.com/lonelyor/SourceFlow/issues/14766
