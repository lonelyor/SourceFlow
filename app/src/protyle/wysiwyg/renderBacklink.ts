...
export const renderBacklink = (protyle: IProtyle, backlinkData: {
    ...
    if (window.sourceflow.config.readonly || window.sourceflow.config.editor.readOnly) {
...
export const loadBreadcrumb = (protyle: IProtyle, element: HTMLElement) => {
    fetchPost("/api/filetree/getDoc", {
        ...
        } else if (window.sourceflow.config.readonly || window.sourceflow.config.editor.readOnly) {
            disabledProtyle(protyle);
