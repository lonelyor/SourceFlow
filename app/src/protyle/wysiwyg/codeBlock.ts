...
export const tabCodeBlock = (protyle: IProtyle, nodeElement: HTMLElement,
    ...
    // https://github.com/lonelyor/SourceFlow/issues/12650
    ...
    let text = "";
    const tabSpace = window.sourceflow.config.editor.codeTabSpaces === 0 ? "\t" : "".padStart(window.sourceflow.config.editor.codeTabSpaces, " ");
    if (!outdent) {
    ...
    // 语言优先级处理 https://github.com/lonelyor/SourceFlow/issues/14767
    if (range.commonAncestorContainer.nodeType === 1) {
        ...
        if (snippetClassName.startsWith("language-")) {
            ...
            // https://github.com/lonelyor/SourceFlow/issues/14767
