...
export const getLabelByNumberFormat = (format: string) => {
    if ("" === format) {
        return window.sourceflow.languages.numberFormatNone;
    } else if ("commas" === format) {
        return window.sourceflow.languages.numberFormatCommas;
    } else if ("percent" === format) {
        return window.sourceflow.languages.numberFormatPercent;
    }

    return window.sourceflow.languages["numberFormat" + format];
};
