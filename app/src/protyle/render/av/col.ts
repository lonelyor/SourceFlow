...
export const addCol = (protyle: IProtyle, blockElement: Element, previousID?: string) => {
    ...
    menu.addItem({
        ...
        click() {
            ...
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.text,
                avID,
                type: "text",
                id,
                previousID
    ...
    menu.addItem({
        id: "number",
        icon: "iconNumber",
        label: window.sourceflow.languages.number,
        click() {
            const id = Lute.NewNodeID();
            const newUpdated = dayjs().format("YYYYMMDDHHmmss");
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.number,
                avID,
                type: "number",
                id,
                previousID
    ...
    menu.addItem({
        id: "select",
        icon: "iconListItem",
        label: window.sourceflow.languages.select,
        click() {
            const id = Lute.NewNodeID();
            const newUpdated = dayjs().format("YYYYMMDDHHmmss");
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.select,
                avID,
                type: "select",
                id,
                previousID
    ...
    menu.addItem({
        id: "multiSelect",
        icon: "iconList",
        label: window.sourceflow.languages.multiSelect,
        click() {
            const id = Lute.NewNodeID();
            const newUpdated = dayjs().format("YYYYMMDDHHmmss");
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.multiSelect,
                avID,
                type: "mSelect",
                id,
                previousID
    ...
    menu.addItem({
        id: "date",
        icon: "iconCalendar",
        label: window.sourceflow.languages.date,
        click() {
            const id = Lute.NewNodeID();
            const newUpdated = dayjs().format("YYYYMMDDHHmmss");
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.date,
                avID,
                type: "date",
                id,
                previousID
    ...
    menu.addItem({
        ...
        click() {
            ...
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.assets,
                avID,
                type: "mAsset",
                id,
                previousID
    ...
    menu.addItem({
        id: "checkbox",
        icon: "iconCheck",
        label: window.sourceflow.languages.checkbox,
        click() {
            const id = Lute.NewNodeID();
            const newUpdated = dayjs().format("YYYYMMDDHHmmss");
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.checkbox,
                avID,
                type: "checkbox",
                id,
                previousID
    ...
    menu.addItem({
        ...
        click() {
            ...
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.link,
                avID,
                type: "url",
                id,
                previousID
    ...
    menu.addItem({
        id: "email",
        icon: "iconEmail",
        label: window.sourceflow.languages.email,
        click() {
            const id = Lute.NewNodeID();
            const newUpdated = dayjs().format("YYYYMMDDHHmmss");
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.email,
                avID,
                type: "email",
                id,
                previousID
    ...
    menu.addItem({
        id: "phone",
        icon: "iconPhone",
        label: window.sourceflow.languages.phone,
        click() {
            const id = Lute.NewNodeID();
            const newUpdated = dayjs().format("YYYYMMDDHHmmss");
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.phone,
                avID,
                type: "phone",
                id,
                previousID
    ...
    menu.addItem({
        ...
        click() {
            ...
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.template,
                avID,
                type: "template",
                id,
                previousID
    ...
    menu.addItem({
        id: "relation",
        icon: "iconOpen",
        label: window.sourceflow.languages.relation,
        click() {
            const id = Lute.NewNodeID();
            const newUpdated = dayjs().format("YYYYMMDDHHmmss");
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.relation,
                avID,
                type: "relation",
                id,
                previousID
    ...
    menu.addItem({
        id: "rollup",
        icon: "iconSearch",
        label: window.sourceflow.languages.rollup,
        click() {
            const id = Lute.NewNodeID();
            const newUpdated = dayjs().format("YYYYMMDDHHmmss");
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.rollup,
                avID,
                type: "rollup",
                id,
                previousID
    ...
    menu.addItem({
        ...
        label: window.sourceflow.languages.lineNumber,
        click() {
            const id = Lute.NewNodeID();
            const newUpdated = dayjs().format("YYYYMMDDHHmmss");
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.lineNumber,
                avID,
                type: "lineNumber",
                id,
                previousID
    ...
    menu.addItem({
        id: "createdTime",
        icon: "iconClock",
        label: window.sourceflow.languages.createdTime,
        click() {
            const id = Lute.NewNodeID();
            const newUpdated = dayjs().format("YYYYMMDDHHmmss");
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.createdTime,
                avID,
                type: "created",
                id,
                previousID
    ...
    menu.addItem({
        id: "updatedTime",
        icon: "iconClock",
        label: window.sourceflow.languages.updatedTime,
        click() {
            const id = Lute.NewNodeID();
            const newUpdated = dayjs().format("YYYYMMDDHHmmss");
            transaction(protyle, [{
                action: "addAttrViewCol",
                name: window.sourceflow.languages.updatedTime,
                avID,
                type: "updated",
                id,
                previousID
