            ...
            mathElements.forEach((mathElement: HTMLElement) => {
                ...
                try {
                    ...
                    if (isBlock) {
                        ...
                        // https://github.com/lonelyor/SourceFlow/issues/3541
                        ...
                        // https://github.com/lonelyor/SourceFlow/issues/4334
                        ...
                        if (!nextSibling) {
                            ...
                            if (mathElement.parentElement.tagName !== "TH" && mathElement.parentElement.tagName !== "TD") {
                                // 光标无法移动到末尾 https://github.com/lonelyor/SourceFlow/issues/2112
                            ...
                            !nextSibling.textContent.startsWith("\n") && // https://github.com/lonelyor/SourceFlow/issues/1089
                            // 输入 $a$ 后，光标移动到其他块，再点击 a 后，光标不显示 https://github.com/lonelyor/SourceFlow/issues/1076#issuecomment-1253215515
