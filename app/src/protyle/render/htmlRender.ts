export const htmlRender = (element: Element) => {
    ...
    htmlElements.forEach((e) => {
        ...
        e.firstElementChild.firstElementChild.setAttribute("aria-label", window.sourceflow.languages.edit);
        e.firstElementChild.lastElementChild.setAttribute("aria-label", window.sourceflow.languages.more);
    });
};
