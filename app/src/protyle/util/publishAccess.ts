...
export const getPublishAccessOptionByLevel = (level: TPublishAccessLevel) => {
    if (level == "protected") {
        return {
            iconHTML: "🔒",
            comment: window.sourceflow.languages.publishAccessProtectedComment,
            visible: true,
            hasPassword: true,
            disable: false,
        };
        ...
        return {
            iconHTML: "👻",
            comment: window.sourceflow.languages.publishAccessHiddenComment,
            visible: false,
            hasPassword: false,
            disable: false,
        };
        ...
        return {
            iconHTML: "🤫",
            comment: window.sourceflow.languages.publishAccessPrivateComment,
            visible: false,
            hasPassword: true,
            disable: false,
        };
        ...
        return {
            iconHTML: "🚫",
            comment: window.sourceflow.languages.publishAccessForbiddenComment,
            visible: false,
            hasPassword: false,
            disable: true,
        };
        ...
        return {
            iconHTML: "🌐",
            comment: window.sourceflow.languages.publishAccessPublicComment,
            visible: true,
            hasPassword: false,
            disable: false,
        };
...
export const openPublishAccessDialog = (id: string, position: IPosition, callback: (access: IPublishAccessItem) => void) => {
    ...
    <button class="block__icon block__icon--show ariaLabel" data-position="north" data-level="public" aria-label="${window.sourceflow.languages.publishAccessPublic}">${getPublishAccessOptionByLevel("public").iconHTML}</button>
    <span class="fn__space"></span>
    <button class="block__icon block__icon--show ariaLabel" data-position="north" data-level="protected" aria-label="${window.sourceflow.languages.publishAccessProtected}">${getPublishAccessOptionByLevel("protected").iconHTML}</button>
    <span class="fn__space"></span>
    <button class="block__icon block__icon--show ariaLabel" data-position="north" data-level="hidden" aria-label="${window.sourceflow.languages.publishAccessHidden}">${getPublishAccessOptionByLevel("hidden").iconHTML}</button>
    <span class="fn__space"></span>
    <button class="block__icon block__icon--show ariaLabel" data-position="north" data-level="private" aria-label="${window.sourceflow.languages.publishAccessPrivate}">${getPublishAccessOptionByLevel("private").iconHTML}</button>
    <span class="fn__space"></span>
    <button class="block__icon block__icon--show ariaLabel" data-position="north" data-level="forbidden" aria-label="${window.sourceflow.languages.publishAccessForbidden}">${getPublishAccessOptionByLevel("forbidden").iconHTML}</button>
    <span class="fn__flex-1"></span>
    <button class="b3-button b3-button--text ariaLabel" data-position="north" aria-label="${window.sourceflow.languages.confirm}"><svg><use xlink:href="#iconSelect"></use></svg></button>
</div>
<div style="padding: 0 8px 8px 8px;text-align: center;">
    <div class="publish-access-dialog__comment">${window.sourceflow.languages.publishAccessPublicComment}</div>
    <div class="fn__hr"></div>
    <div class="b3-form__icon fn__none">
        <svg class="b3-form__icon-icon"><use xlink:href="#iconKey"></use></svg>
        <input class="b3-form__icon-input b3-text-field fn__block" placeholder="${window.sourceflow.languages.password}">
    </div>
</div>`
    });
