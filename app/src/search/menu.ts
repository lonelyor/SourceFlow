...
export const filterMenu = (config: Config.IUILayoutTabSearchConfig, cb: () => void) => {
    const filterDialog = new Dialog({
        title: window.sourceflow.languages.searchType,
...
<div class="b3-dialog__action">
    ...
    btnsElement[1].addEventListener("click", () => {
        ...
        cb();
        window.sourceflow.storage[Constants.LOCAL_SEARCHDATA] = Object.assign({}, config);
...
export const replaceFilterMenu = (config: Config.IUILayoutTabSearchConfig) => {
    let html = "";
    Object.keys(Constants.SOURCEFLOW_DEFAULT_REPLACETYPES).forEach((key: keyof Config.IUILayoutTabSearchConfigReplaceTypes) => {
        html += `<label class="fn__flex b3-label">
    <span class="fn__space"></span>
    <div class="fn__flex-1 fn__flex-center">
        ${window.sourceflow.languages.replaceTypes[key]}
    </div>
    <span class="fn__space"></span>
    ...
    const filterDialog = new Dialog({
        title: window.sourceflow.languages.replaceType,
...
export const queryMenu = (config: Config.IUILayoutTabSearchConfig, cb: () => void) => {
    if (!window.sourceflow.menus.menu.element.classList.contains("fn__none") &&
        window.sourceflow.menus.menu.element.getAttribute("data-name") === Constants.MENU_SEARCH_METHOD) {
        window.sourceflow.menus.menu.remove();
        return;
    }
    window.sourceflow.menus.menu.remove();
    window.sourceflow.menus.menu.element.setAttribute("data-name", Constants.MENU_SEARCH_METHOD);
    window.sourceflow.menus.menu.append(new MenuItem({
        icon: "iconExact",
        label: window.sourceflow.languages.keyword,
    ...
    window.sourceflow.menus.menu.append(new MenuItem({
        icon: "iconQuote",
        label: window.sourceflow.languages.querySyntax,
    ...
    window.sourceflow.menus.menu.append(new MenuItem({
        icon: "iconRegex",
        label: window.sourceflow.languages.regex,
...
export const saveCriterion = (config: Config.IUILayoutTabSearchConfig,
    ...
    const saveDialog = new Dialog({
        title: window.sourceflow.languages.saveCriterion,
        content: `<div class="b3-dialog__content">
        <input class="b3-text-field fn__block" placeholder="${window.sourceflow.languages.memo}">
</div>
<div class="b3-dialog__action">
    <button class="b3-button b3-button--cancel">${window.sourceflow.languages.cancel}</button><div class="fn__space"></div>
    <button class="b3-button b3-button--text">${window.sourceflow.languages.confirm}</button>
    ...
    btnsElement[1].addEventListener("click", () => {
        ...
        if (hasSameName && !hasSameConfig) {
            confirmDialog(window.sourceflow.languages.confirm, window.sourceflow.languages.searchOverwrite, () => {
            ...
            if (hasSameName === hasSameConfig) {
                ...
                confirmDialog(window.sourceflow.languages.confirm, window.sourceflow.languages.searchRemoveName.replace("${x}", removeName).replace("${y}", value), () => {
                    Array.from(criteriaElement.children).forEach(item => {
            ...
            confirmDialog(window.sourceflow.languages.confirm, window.sourceflow.languages.searchUpdateName.replace("${x}", hasSameConfig).replace("${y}", value), () => {
                Array.from(criteriaElement.children).forEach(item => {
...
export const moreMenu = async (config: Config.IUILayoutTabSearchConfig,
                               ...
                               layoutMenu?: () => void) => {
    if (!window.sourceflow.menus.menu.element.classList.contains("fn__none") &&
        window.sourceflow.menus.menu.element.getAttribute("data-name") === Constants.MENU_SEARCH_MORE) {
        window.sourceflow.menus.menu.remove();
        return;
    }
    window.sourceflow.menus.menu.remove();
    window.sourceflow.menus.menu.element.setAttribute("data-name", Constants.MENU_SEARCH_MORE);
    /// #if MOBILE
    window.sourceflow.menus.menu.append(new MenuItem({
        iconHTML: "",
        label: window.sourceflow.languages.listInvalidRefBlocks,
        click() {
            goUnRef();
        }
    }).element);
    ...
    window.sourceflow.menus.menu.append(new MenuItem({
        iconHTML: "",
        label: window.sourceflow.languages.searchType,
        click() {
            filterMenu(config, () => {
    ...
    window.sourceflow.menus.menu.append(new MenuItem({
        iconHTML: "",
        label: window.sourceflow.languages.replaceType,
        click() {
    ...
    window.sourceflow.menus.menu.append(new MenuItem({
        iconHTML: "",
        label: window.sourceflow.languages.searchMethod,
        type: "submenu",
        submenu: [{
            icon: "iconExact",
            label: window.sourceflow.languages.keyword,
    ...
    const sortMenu = [{
        iconHTML: "",
        label: window.sourceflow.languages.type,
        ...
        iconHTML: "",
        label: window.sourceflow.languages.sortByRankAsc,
        ...
        iconHTML: "",
        label: window.sourceflow.languages.sortByRankDesc,
    ...
    if (config.group === 1) {
        sortMenu.push({
            iconHTML: "",
            label: window.sourceflow.languages.sortByContent,
    ...
    window.sourceflow.menus.menu.append(new MenuItem({
        iconHTML: "",
        label: window.sourceflow.languages.group,
        type: "submenu",
        submenu: [{
            iconHTML: "",
            label: window.sourceflow.languages.noGroupBy,
            ...
            iconHTML: "",
            label: window.sourceflow.languages.groupByDoc,
    ...
    window.sourceflow.menus.menu.append(new MenuItem({type: "separator"}).element);
    window.sourceflow.menus.menu.append(new MenuItem({
        label: window.sourceflow.languages.saveCriterion,
        iconHTML: "",
        click() {
    ...
    window.sourceflow.menus.menu.append(new MenuItem({
        iconHTML: "",
        label: window.sourceflow.languages.removeCriterion,
        click() {
            removeCriterion();
        }
    }).element);
...
<button data-type="saveCriterion" class="b3-button b3-button--small b3-button--outline fn__flex-center">${window.sourceflow.languages.saveCriterion}</button>
<span class="fn__space"></span>
<button data-type="removeCriterion" aria-label="${window.sourceflow.languages.useCriterion}" class="ariaLabel b3-button b3-button--small b3-button--outline fn__flex-center fn__flex-shrink" data-position="9south">${window.sourceflow.languages.removeCriterion}</button>
<span class="fn__space"></span>`;
        /// #endif
    });
};
