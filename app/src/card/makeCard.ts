...
<span data-type="rename" class="b3-list-item__action b3-tooltips b3-tooltips__w" aria-label="${window.sourceflow.languages.rename}">
    <svg><use xlink:href="#iconEdit"></use></svg>
</span>
<span data-type="delete" class="b3-list-item__action b3-tooltips b3-tooltips__w" aria-label="${window.sourceflow.languages.delete}">
    <svg><use xlink:href="#iconTrashcan"></use></svg>
</span>
<span data-type="view" class="b3-list-item__action b3-tooltips b3-tooltips__w" aria-label="${window.sourceflow.languages.cardPreview}">
    <svg><use xlink:href="#iconEye"></use></svg>
</span>
<span data-type="remove" class="b3-list-item__action b3-list-item__action--warning b3-tooltips b3-tooltips__w" aria-label="${window.sourceflow.languages.removeDeck}">
    <svg><use xlink:href="#iconMin"></use></svg>
</span>
<span data-type="add" style="display: flex" class="b3-list-item__action b3-tooltips b3-tooltips__w" aria-label="${window.sourceflow.languages.addDeck}">
...
export const makeCard = (app: App, ids: string[]) => {
    ...
    fetchPost("/api/riff/getRiffDecks", {}, (response) => {
        ...
        const dialog = new Dialog({
            ...
            height: "70vh",
            title: window.sourceflow.languages.riffCard,
            content: `<div class="b3-dialog__content fn__flex-column" style="box-sizing: border-box;height: 100%">
    <div class="fn__flex">
        <input class="b3-text-field fn__flex-1">
        <span class="fn__space"></span>
        <span data-type="create" class="block__icon block__icon--show b3-tooltips b3-tooltips__w" aria-label="${window.sourceflow.languages.createDeck}">
            <svg><use xlink:href="#iconAdd"></use></svg>
        </span>
        <span class="fn__space"></span>
        <span data-type="viewall" class="block__icon block__icon--show b3-tooltips b3-tooltips__w" aria-label="${window.sourceflow.languages.cardPreview}">
            <svg><use xlink:href="#iconEye"></use></svg>
        </span>
    </div>
            ...
            while (target && target !== dialog.element) {
                ...
                if (type === "create") {
                    ...
                    if (inputElement.value) {
                        ...
                        msgId = showMessage(window.sourceflow.languages._kernel[142]);
                        inputElement.focus();
                    }
                    ...
                    confirmDialog(window.sourceflow.languages.deleteOpConfirm, `${window.sourceflow.languages.confirmDelete} <b>${escapeHtml(target.parentElement.getAttribute("data-name"))}</b>?`, () => {
                    ...
                    const renameDialog = new Dialog({
                        title: window.sourceflow.languages.rename,
