...
func PinYinCompare(str1, str2 string) bool {
	...
	// Doc tree, backlinks, tags and templates ignores case when sorting alphabetically by name https://github.com/lonelyor/SourceFlow/issues/8360
...
func PinYinCompare4FileTree(str1, str2 string) bool {
	...
	// Improve doc tree Name Alphabet sorting https://github.com/lonelyor/SourceFlow/issues/14773

	str1 = RemoveEmojiInvisible(str1)
	str1 = strings.TrimSuffix(str1, ".sf")
	str2 = RemoveEmojiInvisible(str2)
	str2 = strings.TrimSuffix(str2, ".sf")
