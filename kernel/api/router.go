...
func ServeAPI(ginServer *gin.Engine) {
	...
	ginServer.Handle("POST", "/api/search/saveTemplate", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, saveTemplate)
	...
	ginServer.Handle("POST", "/api/workbench/getWorkbenchItems", model.CheckAuth, getWorkbenchItems)
	ginServer.Handle("POST", "/api/workbench/queryWorkbenchItems", model.CheckAuth, queryWorkbenchItems)
	ginServer.Handle("POST", "/api/workbench/saveWorkbenchItem", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, saveWorkbenchItem)
	...
	ginServer.Handle("POST", "/api/sync/performSyncDownload", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, performSyncDownload)
	...
	ginServer.Handle("POST", "/api/sync/getSyncDiagnostics", model.CheckAuth, model.CheckAdminRole, getSyncDiagnostics)
	...
	ginServer.Handle("POST", "/api/sync/importSyncBackupProfile", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, importSyncBackupProfile)

	ginServer.Handle("POST", "/api/extension/copy", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, extensionCopy)
	ginServer.Handle("POST", "/api/extension/clipURL", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, extensionClipURL)
	ginServer.Handle("POST", "/api/extension/collectSnapshot", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, extensionCollectSnapshot)
	...
	ginServer.Handle("POST", "/api/setting/downloadEditorCursorImage", model.CheckAuth, model.CheckAdminRole, downloadEditorCursorImage)
	...
	ginServer.Handle("POST", "/api/repo/getSnapshotProtectionStat", model.CheckAuth, model.CheckAdminRole, getSnapshotProtectionStat)
	ginServer.Handle("POST", "/api/repo/maintainSnapshotProtection", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, maintainSnapshotProtection)
	...
	ginServer.Handle("POST", "/api/assistant/ai/session/messages", model.CheckAuth, model.CheckAdminRole, assistantAISessionMessages)
	ginServer.Handle("POST", "/api/assistant/ai/session/analyze", model.CheckAuth, model.CheckAdminRole, assistantAISessionAnalyze)
	ginServer.Handle("POST", "/api/assistant/ai/tool/catalog", model.CheckAuth, model.CheckAdminRole, assistantAIToolCatalog)
	...
	ginServer.Handle("POST", "/api/assistant/terminal/profile/list", model.CheckAuth, model.CheckAdminRole, assistantTerminalProfileList)
	ginServer.Handle("POST", "/api/assistant/terminal/session/list", model.CheckAuth, model.CheckAdminRole, assistantTerminalSessionList)
	...
	ginServer.Handle("POST", "/api/assistant/history/revert", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, assistantHistoryRevert)
	ginServer.Handle("POST", "/api/assistant/history/reapply", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, assistantHistoryReapply)
	ginServer.Handle("POST", "/api/assistant/history/recordExplicitSave", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, assistantHistoryRecordExplicitSave)
	ginServer.Handle("POST", "/api/assistant/inbox/create", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, assistantInboxCreate)
	ginServer.Handle("POST", "/api/assistant/agent/list", model.CheckAuth, model.CheckAdminRole, assistantAgentList)
	ginServer.Handle("POST", "/api/assistant/agent/create", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, assistantAgentCreate)
	ginServer.Handle("POST", "/api/assistant/agent/updateStatus", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, assistantAgentUpdateStatus)
	ginServer.Handle("POST", "/api/assistant/agent/updateItem", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, assistantAgentUpdateItem)
	ginServer.Handle("POST", "/api/assistant/agent/updateItems", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, assistantAgentUpdateItems)
	...
	ginServer.Handle("POST", "/api/plugins/setPluginEnabled", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, setPluginEnabled)
	ginServer.Handle("POST", "/api/plugins/inspectLocalPlugin", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, inspectLocalPlugin)
	ginServer.Handle("POST", "/api/plugins/installLocalPlugin", model.CheckAuth, model.CheckAdminRole, model.CheckReadonly, installLocalPlugin)
...
func deprecated(c *gin.Context) {
	logging.LogWarnf("[%s] is deprecated, it will be removed at [%s], visit [https://github.com/lonelyor/SourceFlow/issues/15727] for details",
