...
func exportConf(c *gin.Context) {
	...
	name := "sourceflow-conf-" + time.Now().Format("20060102150405") + ".json"
...
func importConf(c *gin.Context) {
	...
	model.Conf.Bazaar.Normalize()
	util.ApplyBazaarSettings(
		model.Conf.Bazaar.BazaarHash,
		model.Conf.Bazaar.BazaarVersionInfoURL,
		model.Conf.Bazaar.BazaarStageBaseURL,
		model.Conf.Bazaar.BazaarPackageBaseURL,
		model.Conf.Bazaar.BazaarStatBaseURL,
		model.Conf.Bazaar.BazaarReadmeCDNURL,
	)
