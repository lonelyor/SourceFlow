...
func batchReplaceAttributeViewBlocks(c *gin.Context) {
	// Add kernel API `/api/av/batchReplaceAttributeViewBlocks` https://github.com/lonelyor/SourceFlow/issues/15313
	ret := gulu.Ret.NewResult()
	defer c.JSON(http.StatusOK, ret)
...
func appendAttributeViewDetachedBlocksWithValues(c *gin.Context) {
	// Add an internal kernel API `/api/av/appendAttributeViewDetachedBlocksWithValues` https://github.com/lonelyor/SourceFlow/issues/11608
...
func batchSetAttributeViewBlockAttrs(c *gin.Context) {
	// Add kernel API `/api/av/batchSetAttributeViewBlockAttrs` https://github.com/lonelyor/SourceFlow/issues/15310
	ret := gulu.Ret.NewResult()
	defer c.JSON(http.StatusOK, ret)
