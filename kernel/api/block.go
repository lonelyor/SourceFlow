...
func getRefText(c *gin.Context) {
	...
	if "" == refText {
		// 空块返回 id https://github.com/lonelyor/SourceFlow/issues/10259
		refText = id
		ret.Data = refText
		return
	}
	...
	if strings.Count(refText, "\\") == len(refText) {
		// 全部都是 \ 的话使用实体 https://github.com/lonelyor/SourceFlow/issues/11473
...
func getBlockKramdown(c *gin.Context) {
	...
	// https://github.com/lonelyor/SourceFlow/issues/13183
	mode := "md"
