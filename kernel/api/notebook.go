...
func removeNotebook(c *gin.Context) {
	...
	model.TryCreateProtectionSnapshot("delete-notebook")
...
func openNotebook(c *gin.Context) {
	...
	if isUserGuide && util.ContainerIOS == util.Container {
		...
		// Opening the user guide is no longer supported on iOS https://github.com/lonelyor/SourceFlow/issues/11492
		ret.Code = -1
