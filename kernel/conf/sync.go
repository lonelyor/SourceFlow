...
type Sync struct {
	...
	Mode                int     `json:"mode"`                // 同步模式，0：未设置（为兼容已有配置，initConf 函数中会转换为 1），1：自动，2：手动 https://github.com/lonelyor/SourceFlow/issues/5089，3：完全手动 https://github.com/lonelyor/SourceFlow/issues/7295
