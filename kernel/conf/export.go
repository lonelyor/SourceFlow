...
type Export struct {
	...
	//   3：仅锚文本
	//   4：块引转脚注+锚点哈希
	//  （5：锚点哈希 https://github.com/lonelyor/SourceFlow/issues/10265 已经废弃 https://github.com/lonelyor/SourceFlow/issues/13331）
	//  （0：使用原始文本，1：使用 Blockquote，都已经废弃 https://github.com/lonelyor/SourceFlow/issues/3155）
	...
	DocxTemplate          string `json:"docxTemplate"`          // Docx 导出时模板文件路径 TODO 已经废弃，计划于 2026 年 6 月 30 日后删除 https://github.com/lonelyor/SourceFlow/issues/16845
	RemoveAssetsID        bool   `json:"removeAssetsID"`        // Markdown 导出时是否移除资源文件名 ID 部分 https://github.com/lonelyor/SourceFlow/issues/16065
	MarkdownYFM           bool   `json:"markdownYFM"`           // Markdown 导出时是否添加 YAML Front Matter https://github.com/lonelyor/SourceFlow/issues/7727
	InlineMemo            bool   `json:"inlineMemo"`            // 是否导出行级备注 https://github.com/lonelyor/SourceFlow/issues/14605
	IncludeSubDocs        bool   `json:"includeSubDocs"`        // 是否导出子文档 https://github.com/lonelyor/SourceFlow/issues/13635
	IncludeRelatedDocs    bool   `json:"includeRelatedDocs"`    // 是否导出关联文档 https://github.com/lonelyor/SourceFlow/issues/13635
