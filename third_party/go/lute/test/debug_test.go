...
var debugTests = []parseTest{
	...
	{"63", "1. foo\n\nbar\n\n2. baz", "<ol>\n<li>foo</li>\n</ol>\n<p>bar</p>\n<ol start=\"2\">\n<li>baz</li>\n</ol>\n"},
	{"62", "[请从这里开始](sf://blocks/20200812220555-lj3enxa)", "<p><a href=\"sf://blocks/20200812220555-lj3enxa\">请从这里开始</a></p>\n"},
	...
	// 表格和 Setext 标题解析冲突问题 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/110
	{"51", "|   foo   | \n| :-----: |\n|   bar   |\n=======\nbaz\n", "<table>\n<thead>\n<tr>\n<th align=\"center\">foo</th>\n</tr>\n</thead>\n<tbody>\n<tr>\n<td align=\"center\">bar</td>\n</tr>\n</tbody>\n</table>\n<p>=======<br />\nbaz</p>\n"},

	// 表格解析异常 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/52
	{"50", "foo\nname | age |\n---- | ---\n\nbar", "<p>foo</p>\n<table>\n<thead>\n<tr>\n<th>name</th>\n<th>age</th>\n</tr>\n</thead>\n</table>\n<p>bar</p>\n"},
	{"49", "foo\n| bar |\n| --- |", "<p>foo</p>\n<table>\n<thead>\n<tr>\n<th>bar</th>\n</tr>\n</thead>\n</table>\n"},

	// 自动链接渲染问题 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/41
	{"48", "中 https://foo bar\n", "<p>中 https://foo bar</p>\n"},
	{"47", "https://中 bar\n", "<p>https://中 bar</p>\n"},
	{"46", "foo https://” bar\n", "<p>foo https://” bar</p>\n"},
	...
	// 自动链接解析结尾 } 问题 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/4
	...
	{"8", "<\n", "<p>&lt;</p>\n"},
	{"7", "|||\n|||\n", "<p>|||<br />\n|||</p>\n"},
	{"6", "[https://github.com/lonelyor/sourceflow/third_party/go/lute](https://github.com/lonelyor/sourceflow/third_party/go/lute)\n", "<p><a href=\"https://github.com/lonelyor/sourceflow/third_party/go/lute\">https://github.com/lonelyor/sourceflow/third_party/go/lute</a></p>\n"},
	{"5", "[1\n--\n", "<h2 id=\"-1\">[1</h2>\n"},
	{"4", "[1 \n", "<p>[1</p>\n"},
	{"3", "- -\r\n", "<ul>\n<li>\n<ul>\n<li></li>\n</ul>\n</li>\n</ul>\n"},
