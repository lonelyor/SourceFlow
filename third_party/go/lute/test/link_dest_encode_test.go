...
func TestLinkDestDecode(t *testing.T) {
	dest1 := []byte("C:\\Users\\DL882\\Documents\\SourceFlow\\data\\assets\\%E6%B5%8B%E8%AF%95-20210621160821-zxz1j35.pdf")
	decoded := html.DecodeDestination(dest1)
	if !bytes.Equal([]byte("C:\\Users\\DL882\\Documents\\SourceFlow\\data\\assets\\测试-20210621160821-zxz1j35.pdf"), decoded) {
		t.Fatalf("Link dest encode failed")
	}
}
