...
var formatTests = []formatTest{
	...
	// 多状态任务列表格式化 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/221
	{"56", "- [-] cancelled\n- [/] in progress\n- [>] deferred\n- [!] important\n", "- [X] cancelled\n- [X] in progress\n- [X] deferred\n- [X] important\n"},
	{"55", "- [x] done\n- [ ] todo\n- [-] cancelled\n", "- [X] done\n- [ ] todo\n- [X] cancelled\n"},
	{"54", "- [?] question\n", "- [X] question\n"},
	...
	// 链接引用格式化改进 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/36
	{"50", "[text][foo]\n\n[foo]: bar\n", "[text][foo]\n\n[foo]: bar\n"},
	{"49", "[foo]\n\n[foo]: bar\n", "[foo]\n\n[foo]: bar\n"},

	// 格式化支持 Setext 标题 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/29
	{"48", "Setext 标题\n==", "Setext 标题\n===========\n"},
	{"47", "Setext 标题\n------", "Setext 标题\n-----------\n"},
