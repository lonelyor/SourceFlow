	...
	Walk(n, func(n *Node, entering bool) WalkStatus {
		if !entering {
			if nil != n.Next && nil != n.Next.Next && 1 < buf.Len() && n.IsBlock() && buf.Bytes()[buf.Len()-1] != '\n' {
				// 多个块级节点间使用换行符分隔 https://github.com/lonelyor/SourceFlow/issues/8114
				buf.WriteByte('\n')
			}
			return WalkContinue
		}
		...
		case NodeTextMark:
			if "" != n.TextMarkTextContent {
				if n.IsTextMarkType("code") || n.IsTextMarkType("tag") || n.IsTextMarkType("strong") || n.IsTextMarkType("em") || n.IsTextMarkType("a") {
					// 搜索代码内容转义问题 https://github.com/lonelyor/SourceFlow/issues/5927
					// 搜索标签内容转义问题 https://github.com/lonelyor/SourceFlow/issues/13919
					// 搜索加粗、超链接内容转义问题 https://github.com/lonelyor/SourceFlow/issues/14503
...
const (
	...
	// 内容块引用（Block Reference） https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/82
	...
	// ==Mark== 标记语法 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/84
	...
	// kramdown 内联属性列表 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/89 and https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/118

	NodeKramdownBlockIAL NodeType = 455 // 块级内联属性列表 {: name="value"}
	NodeKramdownSpanIAL  NodeType = 456 // 行级内联属性列表 *foo*{: name="value"}bar

	// #Tag# 标签语法 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/92

	NodeTag            NodeType = 460 // 标签
	NodeTagOpenMarker  NodeType = 461 // 开始标签标记符 #
	NodeTagCloseMarker NodeType = 462 // 结束标签标记符 #

	// 内容块查询嵌入（Block Query Embed）语法 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/96
	...
	// 超级块语法 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/111
	...
	// 上标下标语法 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/113
	...
	// Git 冲突标记 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/131
	...
	// 文件注解引用 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/155
	...
	// 属性视图 https://github.com/lonelyor/SourceFlow/issues/7535 <div data-type="NodeAttributeView" data-av-type="table" data-av-id="xxx"></div>

	NodeAttributeView NodeType = 550 // 属性视图

	// 自定义块 https://github.com/lonelyor/SourceFlow/issues/8418 ;;;info
	...
	// 提示块 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/203
