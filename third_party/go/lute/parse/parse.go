	...
	ast.Walk(t.Root, func(n *ast.Node, entering bool) ast.WalkStatus {
		...
		if "" == n.ID {
			...
			if t.Context.ParseOption.ProtyleWYSIWYG && t.Context.ParseOption.Spin &&
				...
				// 这个节点是 spin 后新生成的，将 n.Next 的 ID 和属性赋予它，并认为 n.Next 是新节点 https://github.com/lonelyor/SourceFlow/issues/5723
				n.ID = n.Next.ID
...
type Options struct {
	...
	// Setext 设置是否解析 Setext 标题 https://github.com/lonelyor/sourceflow/third_party/go/lute/issues/50
	Setext bool
	...
	// 其他情况，比如标题块软换行分块 https://github.com/lonelyor/SourceFlow/issues/5723 以及软换行空行分块 https://ld246.com/article/1703839312585
	// 的场景需要移动 IAL 节点，但是 API 输入 markdown https://github.com/lonelyor/SourceFlow/issues/6725）无需移动
	Spin bool
