	...
	ast.Walk(tree.Root, func(n *ast.Node, entering bool) ast.WalkStatus {
		...
		case ast.NodeText, ast.NodeCodeSpanContent, ast.NodeInlineMathContent, ast.NodeLinkText, ast.NodeBlockRefID, ast.NodeHTMLEntity, ast.NodeBackslash:
			...
			if entering {
				...
				content = strings.ReplaceAll(content, "&quot;", "\"") // 粘贴 Markdown 时行级元素中的双引号不再转换为实体 https://github.com/lonelyor/SourceFlow/issues/14503
				...
				} else if nil != n.Parent && ast.NodeHTMLTag == n.Parent.Type && nil != n.Parent.Parent && ast.NodeLink == n.Parent.Parent.Type { // https://github.com/lonelyor/SourceFlow/issues/14788#issuecomment-2882248074
