...
func (r *BaseRenderer) EncodeLinkSpace(dest string) string {
	...
	// Improve export of Markdown hyperlink spaces and markers https://github.com/lonelyor/SourceFlow/issues/9792
...
func (r *BaseRenderer) RelativePath(dest []byte) []byte {
	...
	if !bytes.HasPrefix(dest, []byte("assets/")) &&
		(strings.HasPrefix(r.Options.LinkBase, "https://raw.githubusercontent.com/lonelyor/SourceFlow/main/app/appearance/emojis/") || strings.HasPrefix(r.Options.LinkBase, "https://raw.githubusercontent.com/lonelyor/SourceFlow/main/app/appearance/emojis/")) {
		return dest
	}
