...
import (
	...
	"github.com/lonelyor/sourceflow/third_party/go/pdfcpu/internal/corefont/metrics"
...
func (fd TTFLight) unicodeRangeBits(id string) []int {
	...
	// Please go to https://github.com/lonelyor/sourceflow/third_party/go/pdfcpu/issues/new/choose for an extension request.
	//
