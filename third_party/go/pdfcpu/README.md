...
[![Test](https://github.com/lonelyor/sourceflow/third_party/go/pdfcpu/workflows/Test/badge.svg)](https://github.com/lonelyor/sourceflow/third_party/go/pdfcpu/actions)
...
[![GoDoc](https://godoc.org/github.com/lonelyor/sourceflow/third_party/go/pdfcpu?status.svg)](https://pkg.go.dev/github.com/lonelyor/sourceflow/third_party/go/pdfcpu)
[![Go Report Card](https://goreportcard.com/badge/github.com/lonelyor/sourceflow/third_party/go/pdfcpu)](https://goreportcard.com/report/github.com/lonelyor/sourceflow/third_party/go/pdfcpu)
[![Hex.pm](https://img.shields.io/hexpm/l/plug.svg)](https://opensource.org/licenses/Apache-2.0)
[![Latest release](https://img.shields.io/github/release/pdfcpu/pdfcpu.svg)](https://github.com/lonelyor/sourceflow/third_party/go/pdfcpu/releases)
...
* [API tests](https://github.com/lonelyor/sourceflow/third_party/go/pdfcpu/tree/master/pkg/api/test)
* [API samples](https://github.com/lonelyor/sourceflow/third_party/go/pdfcpu/tree/master/pkg/samples) 
* CLI usage: `$ pdfcpu help cmd`

### GoDoc

* [pdfcpu package](https://pkg.go.dev/github.com/lonelyor/sourceflow/third_party/go/pdfcpu)
* [pdfcpu API](https://pkg.go.dev/github.com/lonelyor/sourceflow/third_party/go/pdfcpu/pkg/api)
* [pdfcpu CLI](https://pkg.go.dev/github.com/lonelyor/sourceflow/third_party/go/pdfcpu/pkg/cli)
...
### Download
Get the latest binary [here](https://github.com/lonelyor/sourceflow/third_party/go/pdfcpu/releases).


### Using Go Modules

```
$ git clone https://github.com/lonelyor/sourceflow/third_party/go/pdfcpu
...
```
$ go install github.com/lonelyor/sourceflow/third_party/go/pdfcpu/cmd/pdfcpu@latest
```
...
* Please [create](https://github.com/lonelyor/sourceflow/third_party/go/pdfcpu/issues/new/choose) an issue if you find a bug or want to propose a change.
* Feature requests - always welcome!
* Bug fixes - always welcome!
* PRs - let's [discuss](https://github.com/lonelyor/sourceflow/third_party/go/pdfcpu/discussions) first or [create](https://github.com/lonelyor/sourceflow/third_party/go/pdfcpu/issues/new/choose) an issue.
* pdfcpu is stable but still *Alpha* and occasionally undergoing heavy changes.

### How

* The pdfcpu [discussion board](https://github.com/lonelyor/sourceflow/third_party/go/pdfcpu/discussions) is open! Please engage in any form helpful for the community.
