...
// go build -ldflags="-X 'github.com/lonelyor/sourceflow/third_party/go/go-sqlite3.driverName=my-sqlite3'"
...
func (c *SQLiteConn) exec(ctx context.Context, query string, args []namedValue) (driver.Result, error) {
	...
	for {
		...
		if tail == "" {
			if res == nil {
				// https://github.com/lonelyor/sourceflow/third_party/go/go-sqlite3/issues/963
