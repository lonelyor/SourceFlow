module github.com/lonelyor/sourceflow/third_party/go/riff

go 1.25.0

require (
	github.com/lonelyor/sourceflow/third_party/go/filelock v0.0.0-20251010020544-2603449ff16d
...
require (
	...
	github.com/lonelyor/sourceflow/third_party/go/httpclient v0.0.0-20260115093840-2754d8028f22 // indirect
